    ...
    <div class="container">
        <form class="form-control fw-bold bg-dark text-warning mt-1 mb-1">
            ...
            <div class="row mt-2 mb-2">
                <div class="col-md-6">
                    <label for="input_pubKey">Chave pública:</label>
                        <input type="text" class="form-control" id="input_pubKey" name="input_pubKey" value="<?php echo $pubKey;?>" readonly required>
                </div>
                <div class="col-md-6">
                    <label for="input_orderType">Tipo de Pagamento:</label>
                        <input type="text" class="form-control" id="input_orderType" name="input_orderType" value="CREDIT" readonly required>
                </div>
            </div>
            <div class="row mb-2">
                <div class="col-md-4">
            ...
            <div class="row mb-2">
                <div class="col-md-6">
                    <label for="input_cc_number">Número do Cartão:</label>
                    <input type="text" class="form-control mb-2" id="input_cc_number" name="input_cc_number" required>
                </div>
                <div class="col-md-2">
                    <label for="input_cc_month">Mês de Validade:</label>
                    <input type="text" class="form-control mb-2" id="input_cc_month" name="input_cc_month" required>
                </div>
                <div class="col-md-2">
                    <label for="input_cc_year">Ano de Validade:</label>
                    <input type="text" class="form-control mb-2" id="input_cc_year" name="input_cc_year" required>
                </div>
                <div class="col-md-2">
                    <label for="input_cc_cvv">Código CVV/CVC:</label>
                    <input type="number" class="form-control mb-2" id="input_cc_cvv" name="input_cc_cvv" required>
                </div>
            </div>
            <!-- Dados do cliente-->
                <div class="row mb-2">
                    <div class="col-md-8">
                        <label for="input_customer_name">Nome no Cartão:</label>
