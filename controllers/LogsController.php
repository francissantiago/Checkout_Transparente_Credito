...
class LogsController{
    ...
    function log_payload(){
		...
		// Formata os dados
		$dados = "\nLog de Payload por cartão de crédito - PAGSEGURO\n\n".$this->response."\n\n\n\n\n\n";
    ...
    function log(){
		...
		// Formata os dados
		$dados = "\nLog de Pagamento por cartão de crédito - PAGSEGURO\n\n".$this->response."\n\n\n\n\n\n";
	...
	function err_log(){
		...
		// Formata os dados
		$dados = "\nLog de Erros de Pagamento por cartão de crédito - PAGSEGURO\n\n".$this->response."\n\n\n\n\n\n";
